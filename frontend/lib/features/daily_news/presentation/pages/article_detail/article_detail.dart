      ...
      builder: (context) => BackdropFilter(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isNewspaper ? theme.dividerColor : Colors.white.withOpacity(0.1),
              width: 1,
            ),
          ),
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                'This feature is currently in development for Phase 4. Soon, you will be able to chat directly with Symmetry\'s AI to get summaries, fact-checks, and deeper insights about this specific article.',
              ...
              const SizedBox(height: 24),
              Text(
                'Check roadmap.md for architectural details.',
                style: theme.textTheme.labelSmall?.copyWith(
                  color: AppColors.accent,
                  letterSpacing: 1.2,
                ),
